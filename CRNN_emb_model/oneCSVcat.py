...
park_royal = open("../hotels-with-categorized-facilities/park_royal(parsed1)_facilities_categorized_facilities.csv",
                  "r")
...
vondelpark = open("../hotels-with-categorized-facilities/vondelpark(parsed)(1)_facilities_categorized_facilities.csv",
                  "r")
westminster = open("../hotels-with-categorized-facilities/westminster(parsed1)_facilities_categorized_facilities.csv",
                   "r")
...
edinburgh = open("../hotels-with-categorized-facilities/Radisson_Blu_ Edinburgh_facilities_categorized_facilities.csv",
                 "r")
edwardian = open("../hotels-with-categorized-facilities/Radisson_Blu_Edwardian_facilities_categorized_facilities.csv",
                 "r")
...
liverpool = open("../hotels-with-categorized-facilities/Radisson_Blu_Liverpool_facilities_categorized_facilities.csv",
                 "r")
manchester = open("../hotels-with-categorized-facilities/Radisson_Blu_Manchester_facilities_categorized_facilities.csv",
                  "r")
...
def add_column_to_csv(predicted, csv1, name_of_hotel, hotel_chain):
    ...
    for line, pred in zip(csv1, predicted):
        ...
        list8.append(line[8])
        list9.append(line[9])
        list11.append(name_of_hotel)
        list12.append(hotel_chain)
        if pred == 0:
            i = 0
        elif pred == 1:
            i = 1
...
def to_csv():
    ...
    df = pd.DataFrame(name_dict)
    df.to_csv('all_hotels_categorized.csv', index=False)
...
add_column_to_csv(predicted_edwardian_london, csv.reader(
    open("../hotels-with-categorized-facilities/Radisson_Blu_Edwardian_London_facilities_categorized_facilities.csv",
         "r")),
...
add_column_to_csv(predicted_sydney, csv.reader(
    open("../hotels-with-categorized-facilities/Radisson_Blu_Plaza Hotel Sydney_facilities_categorized_facilities.csv",
         "r")),
                  'Sydney', 'Radisson Blu')
