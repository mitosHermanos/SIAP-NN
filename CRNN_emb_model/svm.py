...
svm_WORDS = 10000  # Parameter indicating the number of words we'll put in the dictionary
...
# smanjenjem broja iteracija opada tacnost promena losa povecala tacnost
clf = LinearSVC(loss='hinge', max_iter=1000)  # 72%
clf.fit(X_train_tfidf, y_train)


X_train_counts = count_vect.transform(X_test)
print(clf.score(X_train_counts, y_test))
